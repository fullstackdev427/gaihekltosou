...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('user')->group(function(){
        Route::post('/', 'V1\UserController@entry');
        Route::post('login', 'V1\UserController@login');
    });

    Route::prefix('painter')->group(function(){
        Route::post('/', 'V1\PainterController@entry');
        Route::post('login', 'V1\PainterController@login');
    });

    Route::prefix('config')->group(function(){
        Route::post('select', 'V1\ConfigController@select');
    });
});

<template>
  <div class="painter-list" v-if="!isDetails">
    <div>
 
      <!--<div class="row">
        <ul class="list-group list-group-horizontal order-item">
          <li class="list-group-item flex-fill">人気順</li>
          <li class="list-group-item flex-fill">施工事例順</li>
          <li class="list-group-item flex-fill">実績順</li>
          <li class="list-group-item flex-fill">近い順</li>
        </ul>
      </div>-->
  ...
  <div v-else-if="iscolumns && !iscolumnsDetails && !iscolumnsDetailsAll">
...
export default {
  ...
  methods: {
    async onSearch() {
      await axios.get(Api.search).then(response => {
    ...
    async getSeats() {
      ...
      await axios.get(Api.search, {params: params }).then(response => {
